...
namespace mikodev::binary::exceptions
{
    ...
    public:
        [[noreturn]] static void throw_allocator_modified() { throw argument_exception("allocator has been modified unexpectedly!"); }
        ...
        [[noreturn]] static void throw_argument_out_of_range_exception() { throw argument_out_of_range_exception("argument out of range."); }

        [[noreturn]] static void throw_capacity_limited() { throw argument_out_of_range_exception("maximum capacity has been reached."); }

        [[noreturn]] static void throw_not_enough_bytes() { throw not_enough_bytes_exception("not enough bytes."); }

        [[noreturn]] static void throw_not_supported() { throw not_supported_exception("not supported."); }
