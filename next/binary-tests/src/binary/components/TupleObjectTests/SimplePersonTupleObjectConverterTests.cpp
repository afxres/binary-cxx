...
BINARY_TUPLE_OBJECT_CONVERTER(SimplePerson, SimplePersonTupleObjectConverter)
BINARY_TUPLE_MEMBER(Age)
BINARY_TUPLE_MEMBER(Name)
BINARY_TUPLE_OBJECT_CONVERTER_END()

BINARY_TUPLE_OBJECT_CONVERTER(SimplePersonCustom, SimplePersonCustomTupleObjectConverter)
BINARY_TUPLE_MEMBER_CUSTOM(item.GetAge(), item.SetAge(result), std::make_shared<::binary::converters::LittleEndianConverter<int8_t>>())
BINARY_TUPLE_MEMBER_CUSTOM(item.GetName(), item.SetName(result), std::make_shared<::binary::converters::StringConverter>())
BINARY_TUPLE_OBJECT_CONVERTER_END()
