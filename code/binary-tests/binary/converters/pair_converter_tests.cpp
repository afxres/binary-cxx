...
namespace mikodev::binary::tests::converters::pair_converter_tests
{
    ...
    void __size_test(size_t expected_size)
    {
        ...
        BOOST_REQUIRE_EQUAL(expected_size, converter.length());
    }

    BOOST_AUTO_TEST_CASE(pair_converter__size)
    {
        __size_test<int32_t, std::string, mkc::little_endian_converter<int32_t>, mkc::string_converter>(0);
        __size_test<std::string, int32_t, mkc::string_converter, mkc::little_endian_converter<int32_t>>(0);
        __size_test<int32_t, int64_t, mkc::little_endian_converter<int32_t>, mkc::little_endian_converter<int64_t>>(12);
    }
}
