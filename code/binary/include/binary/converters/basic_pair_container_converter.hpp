...
public:
    basic_pair_container_converter(converter_ptr_pair converters)
        : converters_(converters) {}

    basic_pair_container_converter(abstract_converter_ptr<Key> key, abstract_converter_ptr<Value> value)
        : basic_pair_container_converter(std::make_pair(key, value)) {}
