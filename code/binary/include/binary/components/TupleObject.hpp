...
#define BINARY_TUPLE_OBJECT_CONVERTER(ARG_CONVERTER_NAME, ARG_OBJECT_TYPE) \
    BINARY_TUPLE_OBJECT_CONVERTER_INTERNAL_TYPE_DEFINE(ARG_CONVERTER_NAME, ARG_OBJECT_TYPE, ARG_CONVERTER_NAME, )

#define BINARY_TUPLE_OBJECT_CONVERTER_TEMPLATE(ARG_CONVERTER_NAME, ARG_TEMPLATE_TYPE_NAME) \
    BINARY_TUPLE_OBJECT_CONVERTER_INTERNAL_TYPE_DEFINE(ARG_CONVERTER_NAME, ARG_TEMPLATE_TYPE_NAME, ARG_CONVERTER_NAME<ARG_TEMPLATE_TYPE_NAME>, template <typename ARG_TEMPLATE_TYPE_NAME>)
